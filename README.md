...
| Dependency updates | Dependabot monitors npm packages and GitHub Actions monthly with grouped PRs |
...
- Dependabot configuration added for frontend npm, Lambda npm, and GitHub Actions with grouped monthly PRs.
